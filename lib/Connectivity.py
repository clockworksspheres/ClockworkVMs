...
class Connectivity(object):
    ...
    def isPageAvailable(self, url="", timeout=8):
        ...
        self.logger.log(lp.DEBUG, "timeout: " + str(timeout))
        ...
        if isinstance(url, str):
            ...
            if self.isUrlValid(url):
                self.logger.log(lp.DEBUG, "URL is valid...")
                #####
    ...
    def isUrlValid(self, url):
        ...
        if isinstance(url, str) and url:
            ...
            if re.match("^http://.+", url) or re.match("^https://.+", url):
                self.logger.log(lp.DEBUG, "Found valid protocol...")
                urlsplit = url.split("/")
                #####
                ...
                self.logger.log(lp.DEBUG, "urlsplit: " + str(urlsplit))
